    ...
    <Navbar inverse collapseOnSelect fixedTop>
      ...
      <Navbar.Collapse>
        ...
        <Nav pullRight activeKey={pathname}>
          <LinkContainer eventKey="/" exact to="/">
            <NavItem>Search</NavItem>
          </LinkContainer>
          <LinkContainer eventKey="/add_note" to="/add_note">
            <NavItem>Submit</NavItem>
          </LinkContainer>
          <LinkContainer eventKey="/read_me" to="/read_me">
            <NavItem>README</NavItem>
          </LinkContainer>
          {user && user.profile && (
            <LinkContainer eventKey="/user_profile" to="/user_profile">
