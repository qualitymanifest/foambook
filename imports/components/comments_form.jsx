...
const commentsPlaceholder =
  "Summarize what this train typically does here, or describe it's characteristics";
let apiHandle;

const CommentsForm = ({ query, user }) => {
  ...
  const onSubmit = formValues =>
    commentSubmitMethod(formValues, query, setExpanded, apiHandle);
  ...
  return (
    ...
    >
      <Panel.Heading onClick={() => setExpanded(!isExpanded)}>
        <Panel.Title>Add comment</Panel.Title>
      </Panel.Heading>
